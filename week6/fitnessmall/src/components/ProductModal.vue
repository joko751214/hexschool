            ...
            <div class="col-sm-8">
              ...
              <div class="form-row">
                <div class="form-group col-md-6">
                  ...
                  <input type="text" v-model="tempProduct.origin_price"
                  class="form-control" id="origin_price" placeholder="請輸入原價">
                </div>
                <div class="form-group col-md-6">
                  <label for="price">售價</label>
                  <input type="text" v-model="tempProduct.price"
              ...
              <div class="form-check">
                ...
                v-model="tempProduct.enabled" type="checkbox" id="enabled">
...
export default {
  ...
  methods: {
    ...
    getProduct(id) {
      let api = `${process.env.VUE_APP_APIPATH}/${process.env.VUE_APP_UUID}/admin/ec/product/${id}`;
    ...
    uploadFile() {
      ...
      let url = `https://course-ec-url.hexschool.io/api/${process.env.VUE_APP_UUID}/admin/storage`;
